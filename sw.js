const CACHE='savecoin-v1.4.1';
const ASSETS=['./','./index.html','./app.css?v=1.4.1','./app.js?v=1.4.1','./config.js','./db.js','./finance.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./maskable-512.png'];
